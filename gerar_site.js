...
async function processarJogo(jogoFT, indice, total) {
    ...
    const mercados = {
        exp_gols_totais: jogoFT.total_gols_esperado, exp_gols_casa: jogoFT.casa_gols_esperado, exp_gols_fora: jogoFT.fora_gols_esperado,
        exp_cantos_totais: jogoFT.total_cantos_esperado, exp_cantos_casa: jogoFT.casa_cantos_esperado, exp_cantos_fora: jogoFT.fora_cantos_esperado,
        exp_cartoes_totais: jogoFT.total_cartoes_esperado, exp_cartoes_casa: jogoFT.casa_cartoes_esperado, exp_cartoes_fora: jogoFT.fora_cartoes_esperado
    };
